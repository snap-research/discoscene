# python3.7
"""Contains the runner for StyleGAN3."""

from copy import deepcopy

from .base_runner import BaseRunner

__all__ = ['StyleGAN3Runner']


class StyleGAN3Runner(BaseRunner):
    """Defines the runner for StyleGAN3."""

    def build_models(self):
        super().build_models()

        g_ema_img = self.config.models['generator'].get('g_ema_img', 10_000)
        self.g_ema_img = g_ema_img * self.minibatch / 32
