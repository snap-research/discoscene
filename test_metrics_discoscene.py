...
def main():
    ...
    data_transform_kwargs = {'decode': {'center_crop': False,
                                 'image_channels': 3,
                                 'return_square': False,
                                 'transform_type': 'Decode'},
                      'horizontal_flip': {'horizontal_prob': 0.0,
                                          'transform_type': 'Flip',
                                          'vertical_prob': 0.0},
                      'normalize': {'max_val': 1.0,
                                    'min_val': -1.0,
                                    'transform_type': 'Normalize'},
                      'resize2': {'image_size': G.resolution,
                                  'transform_type': 'Resize'}}
    dataset_kwargs = dict(dataset_type='ImageBboxDataset',
                          ...
                          transform_config=data_transform_kwargs,
                          num_bbox=G.num_bbox,
                          )
